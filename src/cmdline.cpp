...
int Configuration::cmdline_settings(int argc, char** argv, double* radius, double* thetamax,
...
int Configuration::config_mapping(int argc, char** argv, boost::program_options::variables_map& dictionary)
{
    /*
    ...
    */
    ...
    std::ifstream config_file(this->file);
    po::options_description init("Options");
